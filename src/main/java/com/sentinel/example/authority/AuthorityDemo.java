 ...
 */
package com.sentinel.example.authority;
...
import com.sentinel.example.exception.ExceptionUtils;
...
public class AuthorityDemo {
    ...
    //    @SentinelResource(value = RESOURCE_NAME, blockHandler = "exceptionBaseHandler", blockHandlerClass = {ExceptionUtils.class})
    public static void testFor2(/*@NonNull*/ String resource, /*@NonNull*/ String origin) {
        ContextUtil.enter(resource, origin);
        Entry entry = null;
        try {
            entry = SphU.entry(resource);
    ...
    @SentinelResource(value = RESOURCE_NAME, blockHandler = "exceptionBaseHandler", blockHandlerClass = {ExceptionUtils.class})
    public static void testFor3(String origin) {
        System.out.println(String.format("Passed for resource %s, origin is %s",RESOURCE_NAME, origin));
    }
